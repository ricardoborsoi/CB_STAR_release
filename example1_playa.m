...
methods = {'HySure','hysure_adaptor','[]',P;
           ...
           'SCOTT','scott_adaptor','[30 30 30]',[];
           'CT-STAR','ctstar_adaptor','[16 16 8]',[3,3,2];
...
res2(1,:) = {'Method', 'SAM', 'ERGAS', 'PSNR', 'UIQI', 'Time'};
res2(2:end,:) = res;
res2
...
optOut{7}{2} = fliplr(rot90(optOut{7}{2},-1));
optOut{8}{2} = fliplr(rot90(optOut{8}{2},-1));
...
% try to plot Psi ---------------------------
plot_psis({optOut{7}{2},optOut{8}{2}}, 'results_examples/estimPsis/ex1_playa_both_algs', {'CT-STAR','CB-STAR'})
