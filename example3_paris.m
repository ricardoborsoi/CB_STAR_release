...
% the Paris data (which *does not* contain variability).
% 
...
d1 = decimFactor; d2 = decimFactor; qq = 3;
...
methods = {'HySure','hysure_adaptor','[]',P;
           ...
           %'LTMR','ltmr_adaptor','[]',{5,1e-3};
           'STEREO','stereo_adaptor','50',[];
           'SCOTT','scott_adaptor','[50 50 5]',[];
           'CT-STAR','ctstar_adaptor','[21 21 7]',[2,2,1];
           'CB-STAR','cbstar_adaptor','[50 50 5]',{[2,2,1],1};
           };
...
est = est([4:8]);
plot_results(Zh_th, est, alg_names, 'results_examples/ex3_paris');



% try to plot Psi ---------------------------
plot_psis({optOut{7}{2},optOut{8}{2}}, 'results_examples/estimPsis/ex3_paris_both_algs', {'CT-STAR','CB-STAR'})

save_results('results_examples/ex3_paris.txt', res2)
